...
[ -z "${DOWNLOAD_DIR}" ] || [ "${DOWNLOAD_DIR}" = "null" ] && DOWNLOAD_DIR="/media/youtube-dlp"
[ -z "${CONFIG_DIR}" ] || [ "${CONFIG_DIR}" = "null" ] && CONFIG_DIR="/share/youtube-dlp"
...
bashio::log.info "Démarrage de l'interface web YouTube-DLP (Flask + yt-dlp)"
