...
| `download_folder` | Dossier des téléchargements | `/media/youtube-dl` |
| `config_folder` | Dossier de configuration yt-dlp | `/share/youtube-dl` |
...
- `/media/youtube-dl` : vidéos téléchargées (accessible via Lecteur multimédia, Samba, Plex…)
- `/share/youtube-dl` : configuration yt-dlp — **à sauvegarder**

### Ports

| Port | Description |
|------|-------------|
| `5000/tcp` | Interface web YouTube-DL (Ingress recommandé) |
