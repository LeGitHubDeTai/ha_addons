...
**Important:** Make sure you've added this addon repository to your Home Assistant addon library: https://github.com/LeGitHubDeTai/ha_addons

1. Navigate in your Home Assistant frontend to **Supervisor** -> **Add-on Store**.
2. Find the "n8n" add-on and click it.
...
Repository: <https://github.com/LeGitHubDeTai/ha_addons>
