...
# bashio::log.warning "This methodology is deprecated, please convert your Environment variables to the addon options env_vars. Instructions can be found here : https://github.com/LeGitHubDeTai/ha_addons/wiki/Add-Environment-variables-to-your-Addon-2"
echo ""
