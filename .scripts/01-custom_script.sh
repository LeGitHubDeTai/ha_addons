...
# bashio::log.notice "This script is used to run custom commands at start of the addon. Instructions here : https://github.com/LeGitHubDeTai/ha_addons/wiki/Running-custom-scripts-in-Addons"
bashio::log.green "Execute $CONFIGFILEBROWSER if existing"

# Download template if no script found and exit
if [ ! -f "$CONFIGSOURCE" ]; then
  TEMPLATESOURCE="https://raw.githubusercontent.com/LeGitHubDeTai/ha_addons/gitea-dev/.scripts/script.template"
